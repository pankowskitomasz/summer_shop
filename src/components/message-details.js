...
class MessageDetails extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-left w-100 border-dark">
                    <thead>
                        <tr>
                            <th colSpan="2"
                ...
                <div className="w-100 text-center">
                    <Button variant={"outline-dark rounded-pill text-dark border-dark me-2"}
                        className="float-left"
                        onClick={this.delete.bind(this)}>
                        Delete
                    </Button>
                    <Button variant={"outline-dark rounded-pill text-dark border-dark"}
