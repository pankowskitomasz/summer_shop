            ...
            <Container fluid className={"contact-form align-items-center p-0 py-5  d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={11} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-danger p-4 rounded bg-orange opacity-9 shadow text-white text-shadow fw-bold"
                            autoComplete="off"
                            method="POST">
                            ...
                            <Form.Group controlId="formFirstName">
                                ...
                                <Form.Control type="text"
                                    ...
                                    className="rounded-pill bg-white border-danger text-dark opacity-8"
                                    maxLength="50"
                                    name="firstName"
                            ...
                            <Form.Group controlId="formMessage" className="mt-3">
                                ...
                                <Form.Control as="textarea"
                                    rows={4}
                                    className="bg-white border-danger text-dark opacity-8"
                                    maxLength="250"
                                    name="messageText"
                                    onChange={this.updateFormData.bind(this)} 
