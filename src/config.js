...
const appCfg = {
    routes:[
        {navItem:true, exact:true, path:"/",name:"Home",view:<Home backLink={{name:"See offer",path:"/offer"}}/>},
...
const APP_LINKS = {
    messages: "http://localhost/summer_shop/public/message.php",
    register: "register.php",
    users: "http://localhost/summer_shop/public/user.php"
};
